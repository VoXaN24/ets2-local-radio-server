...
var g_skinConfig = {
    ...
    "url-prefix": "http://ets2radio.voxhost.fr/",
    "ets2": {
        "map": "http://ets2radio.voxhost.fr/cities/cities-ets2.js",                //What map you're using, this is default + ProMods + RusMap + Project Balkans + Egypt add-on by default. Pick one of the files in the cities folder.
        "stations": "http://ets2radio.voxhost.fr/stations/stations-europe.js",     //What stations file to use, currently only stations-europe available.
    },
    "ats": {
        "map": "http://ets2radio.voxhost.fr/cities/cities-ats.js",                 //What map you're using, this is default by default.
        "stations": "http://ets2radio.voxhost.fr/stations/stations-america.js",    //What stations file to use, currently only stations-america available.
    }
};
